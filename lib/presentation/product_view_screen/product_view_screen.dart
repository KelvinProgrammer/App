...
class ProductViewScreen extends StatelessWidget {
  ...
  Widget _buildOrderStatus(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      SizedBox(height: 8.v),
      BlocSelector<ProductViewBloc, ProductViewState, ProductViewModel?>(
          ...
          builder: (context, productViewModelObj) {
            return Wrap(
                ...
                children: List<Widget>.generate(
                    productViewModelObj?.frame4ItemList.length ?? 0, (index) {
                  Frame4ItemModel model =
                      productViewModelObj?.frame4ItemList[index] ??
                          Frame4ItemModel();
                  return Frame4ItemWidget(model, onSelectedChipView: (value) {
