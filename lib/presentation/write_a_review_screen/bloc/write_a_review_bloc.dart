...
import 'package:kelvin_s_application1/presentation/write_a_review_screen/models/write_a_review_model.dart';
...
class WriteAReviewBloc extends Bloc<WriteAReviewEvent, WriteAReviewState> {
  ...
  _onInitialize(
    ...
    emit(state.copyWith(inputFieldsController: TextEditingController()));
  }
}
